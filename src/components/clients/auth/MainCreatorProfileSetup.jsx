import CreatorProfileSetup from "@/components/Global/Forms/CreatorProfileSetup";
import Image from "next/image";
import Link from "next/link";

export default function MainCreatorProfileSetup() {
  return (
    <div className="h-screen overflow-hidden flex bg-black" data-auth-page="true">
      ...
      <div className="hidden lg:flex flex-1 relative h-screen overflow-hidden">
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-t from-background/60 via-background/30 to-transparent"
          aria-hidden="true"
        />
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Tell us about your creative skills and expertise
          </p>
        </div>
      </div>
    </div>
